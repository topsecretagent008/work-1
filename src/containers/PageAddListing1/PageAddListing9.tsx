...
const PageAddListing9: FC<PageAddListing9Props> = () => {
  ...
  const [nightMin, setNightMin] = useState<string>();
  const [nightMax, setNightMax] = useState<string>();
    ...
    >
      <>
        ...
        <div className="space-y-7">
          {/* ITEM */}
          <NcInputNumber label="Nights min" defaultValue={1} onChange={(e) => console.log("Nights min : ", e)} />
          <NcInputNumber label="Nights max" defaultValue={99} onChange={(e) => console.log("Nights max : ", e)} />
        </div>
