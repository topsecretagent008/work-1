    ...
    <BrowserRouter>
      ...
      <Routes>
        {pages.map(({ component, path }) => {
          ...
          if (component == PageSignUp || component == PageLogin) return <Route key={path} element={<Component />} path={path} />;
          else return <Route key={path} element={<Protected><Component /></Protected>} path={path} />;
        })}
